# Shiden Token Creation Tool

A simple frontend tool to create tokens on the Shiden (SDN) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Shiden-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Shiden Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Shiden-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Shiden wallet address for receiving fees. Also set fee in SDN that you want to charge
